...
class Channel(_BaseModel):
    ...
    # In case you're looking for more fields, OME-XML supports a lot more detail about
    # channels, detectors, light sources, filter sets, etc.
    # https://ome-types.readthedocs.io/en/latest/API/ome_types.model/#ome_types._autogenerated.ome_2016_06.Channel
    # open an issue to request direct support in ome-writers
    # (one can always use `stream.get/update_metadata()` to manually construct OME XML)
